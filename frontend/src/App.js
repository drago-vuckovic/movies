...
import MoviesListPageable from "./components/movie-list-pageable.component";
import UploadFiles from "./components/file-upload.component";
// import ViewMoreComponent from "./components/view-more.component";
      ...
      <div>
        <nav className="navbar navbar-expand navbar-dark bg-dark">
          ...
          <div className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a href="/moviescoversupload" className="nav-link" onClick={this.logOut}>
        ...
        <div className="container mt-3">
          <Switch>
            ...
            <Route exact path="/moviespageable" component={MoviesListPageable} />
            <Route exact path="/add" component={AddMovie} />
            <Route path="/movies/:id" component={Movie} />
            <Route path= "/root" component={Root}/>
            <Route path="/moviescoversupload" component={UploadFiles} />
          </Switch>
        </div>
